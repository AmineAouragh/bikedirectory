...
export function TopNavigation(){
    return (
      <>
        ...
        <nav id="topnav" className="absolute top-0 sticky z-10 bg-white border-b-2 border-slate-100 flex flex-row items-center px-2 justify-between w-full sm:w-3/4 md:w-2/3 py-6">
          <Link href="/">
