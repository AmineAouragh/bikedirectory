...
export function TopNavigation(){
    return (
      <>
        ...
        <nav id="topnav" className="absolute top-0 sticky z-20 opacity-100 h-[100px] bg-white border-b-2 border-slate-100 flex flex-row items-center px-2 justify-between w-full md:w-3/4 xl:w-2/3 py-6">
          <Link href="/">
            <div className="flex flex-row items-center">
              <MdOutlineDirectionsBike size="28" className="text-green-700" />
              <span className="ml-2 text-xl xl:text-2xl font-Inter text-slate-900 font-bold">Bike Wheels Rentals</span>
            </div>
          </Link>
