...
export function TopNavigation(){
    return (
      <>
        ...
        <nav id="topnav" className="absolute top-0 sticky z-20 opacity-90 bg-white border-b-2 border-slate-100 flex flex-row items-center px-2 justify-between w-full md:w-3/4 xl:w-2/3 py-6">
          <Link href="/">
