...
import header_image from '@/public/images/locations/malmo/malmo-header.png'
    ...
    return (
        <>
          <Head>
            ...
            <title>Rent a Bike in Malmo | BikeDirectory</title>
          </Head>
          <div className='px-2 flex flex-col justify-center items-center w-full h-full'>
            ...
            <header className="relative mt-10 md:mt-20 overflow-hidden h-[200px] md:h-[420px] bg-green-800 rounded-xl w-full md:w-2/3 mx-auto flex flex-col justify-center items-center">
                          ...
                          <div className='bg-black bg-opacity-30 absolute inset-0 flex flex-col items-center justify-center'>
                            <h1 className='text-3xl md:text-4xl xl:text-6xl text-center text-white font-bold'>Bikes For Rent in Malmö</h1>
                          </div>
                        </header>
                        ...
                        <section className='flex flex-col md:flex-row w-full md:w-2/3 items-start justify-between'>
                            ...
                            Malmö is Sweden&apos;s most bike-friendly city, with over 500 km of cycle paths. Ride along the waterfront, visit its modern and historic districts, and experience its relaxed cycling culture.
                            </p>
                          </aside>
